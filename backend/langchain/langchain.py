...
def get_langchain_answer(question):
    ...
    If a question is in relation to "current stock" or "stock" look at the inventory.current_stock column.

    If a question is in relation to the "price" or "cost" of a product, look at product.cost
